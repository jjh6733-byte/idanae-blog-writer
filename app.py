...
with tab2:
    ...
    if persona:
        st.success("✨ **업데이트 반영: 대중적이고 자연스러운 인기 맛집 표현 탑재**\n이다내 블로그의 쉼표 호흡(,,)과 친근한 종결어미를 바탕으로, 어색한 AI식 비유 대신 2030 인기 맛집 블로거들이 실제로 가장 많이 쓰는 대중적인 표현(또간집 예약, 재방문의사 200%, 겉바속촉, 밥도둑, 잡내 1도 없음 등)으로 생생하고 자연스럽게 작성합니다.")
